...
## MEJORAS ##
# 'v2.1'
# Añadidos nuevos archivos arr_ELIMINAR
# 'v2.0'
# Código depurado
# 'v1.91'
...
'TorrentLocura.url' 'DivxATope.url' 'DESCARGAS2020 ORG.url' 'PCTNEW ORG.url'  'PCTRELOAD COM.url' 'Descargar peliculas series y estrenos torrent grat.URL' 'ELITETORRENT - Series y Peliculas Torrent sin Limites.url' 'PCTNEW.url' )
